...
SnowDesk is a daily email briefing service for skiers in the Swiss Alps. Each morning and/or evening, subscribers receive a personalised avalanche and conditions summary for their chosen resort, sourced from the Swiss Federal Institute for Snow and Avalanche Research (SLF) bulletin and analysed by Claude (Anthropic).

The service is currently implemented in Next.js and is being migrated to Lovable. This document describes the full product as built, to serve as the source of truth for that migration.
...
A single-page marketing and sign-up interface. From top to bottom:
